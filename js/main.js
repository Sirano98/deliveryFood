...
const inpuSearch = document.querySelector(".input-search");
...
function init() {
  ...
  inpuSearch.addEventListener("keypress", function (event) {
          ...
          linkProducts.forEach(function (link) {
            getData(`./db/${link}`)
              .then(function (data) {
                ...
                restaurantTitle.textContent = "Зезультаты поиска";
                restaurantCategory.textContent = "";
                restaurantPrice.textContent = "";
                restaurantRating.textContent = "";

                resultSearch.forEach(createGood);
              })
          })
        })
    }
